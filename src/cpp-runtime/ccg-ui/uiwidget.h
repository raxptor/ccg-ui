...
namespace ccgui
{
	...
	namespace uiwidget
	{
		...
		struct element_handler
		{
			...
			virtual void on_layout(outki::UIElement *element, element_layout *layout) = 0;
			virtual void update(outki::UIElement *element, uiscreen::renderinfo *rinfo, element_layout *layout) = 0;
			virtual void draw(outki::UIElement *element, uiscreen::renderinfo *rinfo, element_layout *layout) = 0;
		};
